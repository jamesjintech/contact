...
const PortfolioLanding = () => {
    ...
    return (
        <div className="active-dark bg_color--9">
            <Helmet pageTitle="Portfolio Landing" title="James Jin" />
            ...
            <div id="home" className="fix">
                <div className="slider-activation with-particles">
                    ...
                    {SlideList.map((value , index) => (
                        <div className="slide personal-portfolio-slider slider-paralax slider-style-3 d-flex align-items-center justify-content-center bg_image bg_image--25 bg_color--8" key={index}>
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className={`inner ${value.textPosition}`}>
                                            {value.category ? <span>{value.category}</span> : ''}
                                            <h1 className="title mb--60">Are you based in EU or America?<br/>
                                            <TextLoop interval={1600} className='mt--30'>
                                                <span className="theme-gradient">No Speciall Skills Required!</span>
                                                <span className="theme-gradient">Basic English & Collaboration</span>
                                                <span className="theme-gradient">100% Remote & Flexible Schedule</span>
                                                <span className="theme-gradient">Only require 1Hr/day</span>
                                                <span>Earn 30% of Income</span>
                                            </TextLoop>{" "}
                                            </h1>
                                            <h2>Let's Partner Up!</h2>
                                            {value.description ? <p className="description">{value.description}</p> : ''}
                                            <ul className="social-share social-style--2 color-black d-flex justify-content-start liststyle custom">
                            ...
                            <div className="row row--35">
                                <div className="col-lg-5">
                                    <div className="thumbnail mt--60">
                                        <img className="w-100" src="/contact/assets/images/about/about-23.jpg" alt="About Images"/>
                                    </div>
                                </div>
            ...
            {/* <div id="contact" className="fix">
                <div className="rn-contact-area pbt--120 bg_color--8">
                    <ContactThree contactImages="/contact/assets/images/about/about-13.jpg" contactTitle="Contact Me" />
                </div>
            </div> */}
            {/* End COntact Area */}
